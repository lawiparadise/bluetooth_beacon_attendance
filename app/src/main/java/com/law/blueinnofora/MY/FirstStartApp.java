  ...
  //  saveECTClass();
   //    showScheduleInput();
    ...
    //    Intent intent = new Intent(this,calendarMonthViewActivity.getClass());
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_SINGLE_TOP); //이렇게 하면 된다.....or
      //  intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);   //이렇게 add로도 가능하다
