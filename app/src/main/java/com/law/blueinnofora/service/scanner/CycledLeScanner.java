package com.law.blueinnofora.service.scanner;
...
import com.law.blueinnofora.startup.StartupBroadcastReceiver;
 ...
 //               scanPeriod, betweenScanPeriod);
   ...
   //     Log.e(TAG,"MY : SCAN!!!");
        ...
        if (getBluetoothAdapter() == null) {
            Log.e(TAG,"MY : No Bluetooth adapter, BeaconService cannot scan");
